...
<head>
    <title>吃掉薛司令</title>
    <meta itemprop="name" content="吃掉薛司令" />
    <meta itemprop="description" content="新概念鸡汤" />
...
<body onLoad="init()" oncontextmenu=self.event.returnValue=false>
    <div id="GameScoreLayer" class="BBOX SHADE bgc1" style="display:none;">
        <div style="padding:5%;margin-top: 200px;background-color: rgba(125, 181, 216, 0.3);">
            ...
            <button type="button" class="btn btn-secondary btn-lg" onclick="window.location.href='https://space.bilibili.com/440830005">b站</button>
            <button type="button" class="btn btn-secondary btn-lg" onclick="window.location.href='https://github.com/huanmingzhuo/CDXSL">开源</button>
            ...
            <button type="button" class="btn btn-secondary btn-lg" onclick="window.location.href='https://github.com/arcxingye/EatKano'">原版游戏</button>
